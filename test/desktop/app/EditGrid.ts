...
!function () { 
    ...
    Design.define('Design.app.EditGrid', {
        ...
        columns: [
			...
			{ text: 'price', width: 125, dataIndex: 'price', align: 'center', editor: { xtype: 'textfield', vtype: 'decimals' } },
			{ text: 'change', width: 125, dataIndex: 'change', editor: { xtype: 'combobox', displayField: 'name', valueField: 'id', data: [{ name: 'a1', id: 1 }, { name: 'a2', id: 2 }] } },
			{ text: 'pctChange', width: 125, dataIndex: 'pctChange' },
			{ text: 'lastChange', width: 135, dataIndex: 'lastChange', editor: { xtype: 'datefield' } }
        ],
        data: myData
    });
